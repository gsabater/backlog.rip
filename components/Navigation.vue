<template>
  <div class="navbar-expand-md">
    <div class="collapse navbar-collapse" id="navbar-menu">
      <div class="navbar navbar-light">
        <div class="container-xl">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <NuxtLink to="/dev/pinia" class="nav-link">
                <span class="nav-link-title">
                  Pinia
                </span>
              </NuxtLink>
            ...
            <li class="nav-item dropdown" @click="ui.menu = 'dropdown-1'">
              <a class="nav-link dropdown-toggle" :class="{ 'show': ui.menu == 'dropdown-1' }" href="#navbar-base"
              ...
              <div class="dropdown-menu" :class="{ 'show': ui.menu == 'dropdown-1' }" data-bs-popper>
      ...
      <div v-if="ui.menu" @click="ui.menu = false" class="navbar-backdrop" style="position: fixed;
        top: 0; left: 0;
        z-index: 1;
        width: 100vw;
        height: 100vh;"></div>
