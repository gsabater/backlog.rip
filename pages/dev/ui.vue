<template>
  <div class="page-body">
    <div class="container-xl">
      ...
      <b-btn variant="outline" color="success">Outline green</b-btn>
      <b-btn variant="ghost" color="warning">Text</b-btn>
      <b-btn disabled>Disabled</b-btn>
      <b-btn variant="icon" color="youtube">
      ...
      <b-btn color="warning" block>BLOCK</b-btn>
      ...
      <div class="row">
        <div class="col">
          <b-input label="text" v-model="one"></b-input>
        </div>
        <div class="col">
          <b-input label="pass" type="password" v-model="one"></b-input>
        </div>
        <div class="col">
          <b-input label="Disabled > 3" :disabled="one.length > 2"></b-input>
        </div>
        <div class="col"><b-input label="Required" required></b-input></div>
        <div class="col">
          <b-input label="floating" v-model="one" variant="floating"></b-input>
        </div>

        <div class="col card">
          <div class="card-body">

            <b-input label="floating" v-model="one" variant="floating"
            placeholder="floatttting"></b-input>
          </div>
        </div>
        <div class="col"><pre>{{ one }}</pre></div>
      </div>
      ...
      <div class="row">
        <div class="col"><pre>{{ two }}</pre></div>
        <div class="col">
          <b-select
            label="Single select"
            v-model="two"
            :items=" Array.from({length: 30}, () => Math.random().toString(36).substring(2, 12))">
          </b-select>
        </div>
        <div class="col">
          <b-select
