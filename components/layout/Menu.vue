...
#menu .v-list-item .v-list-group__header__prepend-icon {
  margin-right: 22px !important;
}

#menu .v-list-group .v-list-group__items .v-list-item__icon {
  margin: 0;
  padding: 0;
  width: 0;
  min-width: 4px;
...
#menu .v-list-group .v-list-group__items .v-list-item__icon:before {
  content: '';
  width: 6px;
  height: 2px;
