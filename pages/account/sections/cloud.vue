<template>
  ...
  <div v-if="$auth.config.cloud" class="card mb-3">
    <div class="card-body">
      ...
      <div class="row g-3">
        <div class="d-flex align-items-center" v-if="$cloud.is == 'disconnected'">
          <div
            class="avatar avatar-sm rounded-circle bg-gray-600"
            style="--tblr-bg-opacity: 0.3">
            <Icon size="18" width="1.5">CloudOff</Icon>
          </div>
          <div class="ms-3">
            <span class="text-body">Disconnected</span>
            <div class="text-secondary">
              A connection to the cloud could not be established
            </div>
          </div>
        </div>
