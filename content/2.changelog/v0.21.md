...
<small class="text-muted d-block my-3">
              This release will not be notified as a public release
            </small>

 since it has been a foundation update for future features. However, it does include some new features, improvements, and bug fixes.
...
### Improvements
- Several improvements have been made to the list editor
