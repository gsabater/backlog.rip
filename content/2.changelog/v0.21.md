...
<div style="text-align: center;">
  <img src="/img/changelog/v0.x.png" alt="Power search and filter your games"  width="100%">
</div>
...
### Improvements
- Now it's possible to configure the amount of games to show per page in the pagination settings
- Added the possibility to pin "uncategorized" games to the sidebar for quick access
- Added singleton instances to tooltips to avoid overlapping
- Updating a game state no longer triggers a search.
- Hiding a game now grayscales it in search results instead of removing it immediately, making it easier to undo or review hidden items
