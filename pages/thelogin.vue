    ...
    <div class="container container-tight py-4">
      ...
      <div class="card card-md">
        <div class="card-body">
          ...
          <form action="./" method="get" autocomplete="off" novalidate="" data-bitwarden-watching="1">
            <div class="mb-3">
              ...
              <div class="form-floating mb-3">
                <input type="password" class="form-control" id="floating-password" autocomplete="off">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col"><a href="http://api.backlog.rip/auth/steam" class="btn btn-github w-100">
            ...
            <div class="col"><a href="http://api.backlog.rip/auth/google" class="btn btn-green w-100">
                <!-- Download SVG icon from http://tabler-icons.io/i/brand-twitter -->
            ...
            <div class="col"><a href="http://api.backlog.rip/auth/google" class="btn btn-google w-100">
                <!-- Download SVG icon from http://tabler-icons.io/i/brand-twitter -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-google" width="40"
                  height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                  stroke-linecap="round" stroke-linejoin="round">
